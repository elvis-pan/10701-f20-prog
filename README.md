...
<img src="https://render.githubusercontent.com/render/math?math=P(x)=\frac{1}{\sqrt{2\pi(\sigma^2 %2B \epsilon)}}\exp\left(-\frac{(x-\mu)^2}{2(\sigma^2 %2B \epsilon)}\right)">, where <img src="https://render.githubusercontent.com/render/math?math=\epsilon = 10^{-9}"> is a small factor to ensure the variance is not 0.
